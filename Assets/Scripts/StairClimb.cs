...
public class StairClimb : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        stepRayUpper.transform.position = new Vector3(stepRayLower.transform.position.x, stepRayLower.transform.position.y + 0.5f, stepRayLower.transform.position.z);
    }
